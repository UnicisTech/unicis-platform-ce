...
ENV APP_URL=${APP_URL}
ARG NEXT_INTERNAL_APP_URL=http://127.0.0.1:4002
ENV NEXT_INTERNAL_APP_URL=${NEXT_INTERNAL_APP_URL}
ARG FLEET_API_URL=${FLEET_API_URL}
ENV FLEET_API_URL=${FLEET_API_URL}
ARG FLEET_API_HOST=${FLEET_API_HOST}
ENV FLEET_API_HOST=${FLEET_API_HOST}
ARG NEXT_PUBLIC_FLEET_API_URL=${NEXT_PUBLIC_FLEET_API_URL}
ENV NEXT_PUBLIC_FLEET_API_URL=${NEXT_PUBLIC_FLEET_API_URL}
ARG NEXT_PUBLIC_FLEET_API_HOST=${NEXT_PUBLIC_FLEET_API_HOST}
ENV NEXT_PUBLIC_FLEET_API_HOST=${NEXT_PUBLIC_FLEET_API_HOST}
...
# Apply pending database migrations against the real runtime DATABASE_URL,
