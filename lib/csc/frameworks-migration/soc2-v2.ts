export default [
  ...
  },
  {
    ...
    requirements:
      "Operations Objectives — Reflects Management's Choices — Operations objectives reflect management's choices about structure, industry considerations, and performance of the entity.",
  },
  {
    id: 'soc2-v2-cc3-1-2',
    section: 'Risk Assessment',
  ...
  },
  {
    ...
    requirements:
      'External Financial Reporting Objectives — Complies With Applicable Accounting Standards — Financial reporting objectives are consistent with accounting principles suitable and available for that entity. The accounting principles selected are appropriate in the circumstances.',
  },
  {
    id: 'soc2-v2-cc3-1-6',
    section: 'Risk Assessment',
  ...
  },
  {
    ...
    requirements:
      'External Nonfinancial Reporting Objectives — Complies With Externally Established Frameworks — Management establishes objectives consistent with laws and regulations or standards and frameworks of recognized external organizations.',
  },
  {
    id: 'soc2-v2-cc3-1-9',
    section: 'Risk Assessment',
  ...
  },
  {
    ...
    requirements:
      "Internal Reporting Objectives — Reflects Management's Choices — Internal reporting provides management with accurate and complete information regarding management's choices and information needed in managing the entity.",
  },
  {
    id: 'soc2-v2-cc3-1-12',
    section: 'Risk Assessment',
  ...
  },
  {
    ...
    requirements:
      'Compliance Objectives — Reflects External Laws and Regulations — Laws and regulations establish minimum standards of conduct, which the entity integrates into compliance objectives.',
  },
  {
    id: 'soc2-v2-cc3-1-15',
    section: 'Risk Assessment',
