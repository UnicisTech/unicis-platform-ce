...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    //  className
    className={cn(
      'flex h-9 w-full items-center justify-between overflow-hidden truncate rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-xs ring-offset-background data-placeholder:text-muted-foreground focus:outline-hidden focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:truncate',
      className
    )}
    {...props}
  >
    {/* TODO: any is a temporary fix for ts */}
    {children as any}
