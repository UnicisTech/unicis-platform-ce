...
import { Field, RangeField, FieldProps, FormFooter, HelperMessage, ErrorMessage } from '@atlaskit/form';
...
interface FormBodyProps {
  ...
  isPermitted: boolean;
  procedureFieldHandler: (e: React.ChangeEvent<HTMLInputElement>, setFieldValue: (name: string, value: any) => void, stage: number) => void;
