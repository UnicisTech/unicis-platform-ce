...
const TiaPanel = ({
  ...
  return (
    <IssuePanelContainer>
      <h2 className="text-1xl font-bold">View Transfer Impact Assessment</h2>
      {procedure
        ? <Tabs
          ...
          <TabPanel>
            <div>
              <Field
                ...
                value={config["EncryptionInTransit"].find(({ value }) => value === procedure[1].EncryptionInTransit)?.label!}
              />
              <Field
              ...
              <Field
                ...
                value={config["TransferMechanism"].find(({ value }) => value === procedure[1].TransferMechanism)?.label!}
              />
              <Field
              ...
              <Field
                ...
                value={config["LawfulAccess"].find(({ value }) => value === procedure[1].LawfulAccess)?.label!}
              />
              <Field
              ...
              <Field
                ...
                value={config["MassSurveillanceTelecommunications"].find(({ value }) => value === procedure[1].MassSurveillanceTelecommunications)?.label!}
              />
              <Field
              ...
              <Field
                ...
                value={config["SelfReportingObligations"].find(({ value }) => value === procedure[1].SelfReportingObligations)?.label!}
              />
              <Field
                label={fieldPropsMapping["ReasonMassSurveillanceTelecommunications"]}
                value={procedure[1].ReasonMassSurveillanceTelecommunications}
          ...
          <TabPanel>
            <div>
              <Field
                ...
                value={config["WarrantsSubpoenas"].find(({ value }) => value === procedure[2].WarrantsSubpoenas)?.label || NOT_APLICABLE}
              />
              <Field
                label={fieldPropsMapping["ReasonMassSurveillanceTelecommunications"]}
              ...
              <Field
                ...
                value={config["ViolationLocalLaw"].find(({ value }) => value === procedure[2].ViolationLocalLaw)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["HighViolationLocalLaw"].find(({ value }) => value === procedure[2].HighViolationLocalLaw)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["HighViolationDataIssue"].find(({ value }) => value === procedure[2].HighViolationDataIssue)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["InvestigatingImporter"].find(({ value }) => value === procedure[2].InvestigatingImporter)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["PastWarrantSubpoena"].find(({ value }) => value === procedure[2].PastWarrantSubpoena)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["DataIssueInvestigation"].find(({ value }) => value === procedure[2].DataIssueInvestigation)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["LocalIssueWarrants"].find(({ value }) => value === procedure[2].LocalIssueWarrants)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["LocalMassSurveillance"].find(({ value }) => value === procedure[2].LocalMassSurveillance)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["LocalAccessMassSurveillance"].find(({ value }) => value === procedure[2].LocalAccessMassSurveillance)?.label || NOT_APLICABLE}
              />
              <Field
                label={fieldPropsMapping["ReasonLocalAccessMassSurveillance"]}
                value={procedure[2].ReasonLocalAccessMassSurveillance || NOT_APLICABLE}
              />
              <Field
                label={fieldPropsMapping["LocalRoutinelyMonitor"]}
                value={config["LocalRoutinelyMonitor"].find(({ value }) => value === procedure[2].LocalRoutinelyMonitor)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["PassMassSurveillance"].find(({ value }) => value === procedure[2].PassMassSurveillance)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              />
              <RiskLevel
                value={nonTargetedRisk}
              />
              <Field
                label={fieldPropsMapping["PassMassSurveillanceConnection"]}
                value={config["PassMassSurveillanceConnection"].find(({ value }) => value === procedure[2].PassMassSurveillanceConnection)?.label || NOT_APLICABLE}
              />
              <Field
                label={fieldPropsMapping["ReasonPassMassSurveillanceConnection"]}
                value={procedure[2].ReasonPassMassSurveillanceConnection || NOT_APLICABLE}
              />


              <Field
                label={fieldPropsMapping["ImporterObligation"]}
                value={config["ImporterObligation"].find(({ value }) => value === procedure[2].ImporterObligation)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["LocalSelfReporting"].find(({ value }) => value === procedure[2].LocalSelfReporting)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                ...
                value={config["PastSelfReporting"].find(({ value }) => value === procedure[2].PastSelfReporting)?.label || NOT_APLICABLE}
              />
              <Field
              ...
              />
              <RiskLevel
                value={selfReportingRisk}
              />
              <Field
                label={fieldPropsMapping["AssessmentProduceReport"]}
                value={config["AssessmentProduceReport"].find(({ value }) => value === procedure[2].AssessmentProduceReport)?.label || NOT_APLICABLE}
              />
              <Field
                label={fieldPropsMapping["ReasonAssessmentProduceReport"]}
                value={procedure[2].ReasonAssessmentProduceReport || NOT_APLICABLE}
              />
            </div>
          </TabPanel>
          <TabPanel>
            <div>
              <Field
                label={questions["DataTransferImporter"]}
              />
              <Field
              ...
              <Field
                ...
                value={procedure[3].ProbabilityDataTransferImporter || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                label={questions["TransferToImporter"]}
              />
              <Field
              ...
              <Field
                ...
                value={procedure[3].ProbabilityTransferToImporter || NOT_APLICABLE}
              />
              <Field
              ...
              <Field
                label={questions["TransferToImporterForPerformance"]}
              />
              <Field
                label={fieldPropsMapping["RelevantTransferToImporterForPerformance"]}
                value={procedure[3].RelevantTransferToImporterForPerformance || NOT_APLICABLE}
              />
              <Field
                label={fieldPropsMapping["ProbabilityTransferToImporterPerformance"]}
                value={procedure[3].ProbabilityTransferToImporterPerformance || NOT_APLICABLE}
              />
              <Field
                label={fieldPropsMapping["ReasonTransferToImporterPerformance"]}
                value={procedure[3].ReasonTransferToImporterPerformance || NOT_APLICABLE}
              />

              <Field
                label={questions["LegalGround"]}
              />
              <Field
