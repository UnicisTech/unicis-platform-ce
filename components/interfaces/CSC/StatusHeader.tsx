        ...
        <table>
            ...
            <tbody>
                ...
                <tr style={{...rowStyle, backgroundColor: 'rgba(202,0,63,255)'}}>
                    ...
                    <td>Development has barely started and will require significant work to fulfill the requirements</td>
                </tr>
                ...
                <tr style={{...rowStyle, backgroundColor: 'rgba(255,190,0,255)'}}>
                    ...
                    <td>Development is more or less complete, although detail is lacking and/or it is not yet implemented, enforced and actively supported by top management</td>
                </tr>
                ...
                <tr style={{...rowStyle, backgroundColor: 'rgba(47,143,0,255)'}}>
                    ...
                    <td>The requirement is fully satisfied, is operating fully as expected, is being actively monitored and improved, and there is substantial evidence to prove all that to the auditors</td>
                </tr>
            </tbody>
        </table>
        ...
        <Popup
            ...
            trigger={(triggerProps) => (
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <span>Status</span>
                    <Button onClick={() => setIsOpen(!isOpen)} iconBefore={<EditorPanelIcon size="small" label="test" />} appearance="subtle-link" {...triggerProps}></Button>
                </div>
            )}
        />
    )
