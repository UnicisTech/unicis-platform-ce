...
// ── Shared th style ───────────────────────────────────────────────────────────
const TH =
  'px-2 py-2 text-left text-[11px] font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide whitespace-nowrap';
          ...
          <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700 text-[12px]">
            <thead className="bg-slate-50 dark:bg-slate-900">
              ...
              <tr className="border-b border-slate-100 dark:border-slate-700">
                ...
                <th
                  colSpan={3}
                  className={`${TH} border-l border-slate-200 dark:border-slate-700 text-center`}
                >
              ...
              <tr>
                ...
                <th
                  className={`${TH} border-l border-slate-200 dark:border-slate-700`}
                >
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
              {pageData.map((task) => {
                ...
                const owner =
                  membersById.get(risk[0].AssetOwner) ?? t('not-found');
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      className={`px-2 py-2 whitespace-nowrap font-medium ${getRiskClass(raw, isDark)}`}
                    >
                    ...
                    <td
                      className={`px-2 py-2 whitespace-nowrap font-medium ${getRiskClass(target, isDark)}`}
                    >
                    ...
                    {/* Current risk */}
                    <td
                      className={`px-2 py-2 border-l border-slate-100 dark:border-slate-700 whitespace-nowrap font-medium ${getRiskClass(current, isDark)}`}
                    >
