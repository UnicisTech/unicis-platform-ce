...
const Comment = ({ comment, commentToEdit, setCommentToEdit, updateComment, deleteComment }: CommentProps) => {
    ...
    return (
        <div className='flex gap-2'>
            <CommentAvatar image={comment.createdBy.image} username={comment.createdBy.name} />
