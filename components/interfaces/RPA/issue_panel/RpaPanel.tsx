...
const DescriptionAndStakeholdersTab: React.FC<{ step: RpaProcedureInterface[0] }> = ({ step }) => (
...
const PurposeAndCategoriesTab: React.FC<{ step: RpaProcedureInterface[1] }> = ({ step }) => (
  <div className="space-y-2">
    {step.purpose && <Field label={fieldPropsMapping.purpose} value={step.purpose} />}
    <Field
    ...
    />
    <Field label={fieldPropsMapping.retentionperiod} value={step.retentionperiod.label} />
...
const RecipientsTab: React.FC<{ step: RpaProcedureInterface[2] }> = ({ step }) => (
  <div className="space-y-2">
    <Field
...
const SecurityMeasuresTab: React.FC<{ step: RpaProcedureInterface[4] }> = ({ step }) => (
  <div className="space-y-2">
    <Field
