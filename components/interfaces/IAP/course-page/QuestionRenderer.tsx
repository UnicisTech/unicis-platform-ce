...
import type { SingleChoiceQuestion, MultipleChoiceQuestion, OrderQuestion, TextQuestion, Question } from "types"
import { QuestionType } from "types";

const SingleChoiseQuestion = ({ question, onAnswerUpdate }: { question: SingleChoiceQuestion, onAnswerUpdate: (answer: any) => void }) => {
...
const OrderQuestion = ({ question, onAnswerUpdate }: { question: OrderQuestion, onAnswerUpdate: (answer: any) => void }) => {
...
const QuestionRenderer = ({ question, onAnswerUpdate }: { question: Question, onAnswerUpdate: (answer: any) => void }) => {
    switch (question.type) {
        case QuestionType.SINGLE_CHOICE:
            return <SingleChoiseQuestion question={question} onAnswerUpdate={onAnswerUpdate} />
