  ...
  const loginFormik = useFormik({
    ...
    onSubmit: async ({ fleetPassword }) => {
      ...
      try {
        ...
        toast.error(t('fleet-login-failed'));
      }
    },
  });
  ...
  const changeFormik = useFormik({
    ...
    onSubmit: async ({ newPassword }) => {
      try {
        ...
        toast.error(t('fleet-password-update-failed'));
      }
    },
  });
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        toast.error(error.error || t('fleet-forgot-password-failed'));
        return;
      }
      ...
      toast.error(t('fleet-forgot-password-failed'));
    } finally {
      ...
      <Dialog open={visible} onOpenChange={setVisible}>
        <DialogContent className="sm:max-w-md">
          {showForgotPassword ? (
            <div>
              <DialogHeader>
                <DialogTitle>{t('fleet-forgot-password')}</DialogTitle>
                <DialogDescription>
            ...
            <form onSubmit={loginFormik.handleSubmit}>
              ...
              <div className="mt-4 space-y-2">
                <Label>{t('fleet-user-password')}</Label>
                <Input
                  type="password"
                  name="fleetPassword"
            ...
            <form onSubmit={changeFormik.handleSubmit}>
              <DialogHeader>
                <DialogTitle>{t('fleet-change-password')}</DialogTitle>
                <DialogDescription>
                  {t('fleet-must-change-password')}
                </DialogDescription>
              </DialogHeader>
