    ...
    <div>
      <div className="grid gap-8">
        <div className="grid grid-cols-2 gap-2">
          ...
          />
          <DataInfo
            header={t('host-identifier')}
            data={node?.host_identifier}
          />
        ...
        <div>
          <DataInfo
            ...
            data={t('system-information-desc')}
          />
          <div className="grid grid-cols-2 gap-2">
            <DataInfo
        ...
        <div>
          <DataInfo
            header={t('agent-information')}
            data={t('agent-information-desc')}
          />
          <div className="grid grid-cols-4 gap-2">
            ...
            <DataInfo
              header={t('pid')}
              data={node?.node_info?.osquery_info?.pid}
            />
            <DataInfo
        ...
        <div>
          <DataInfo
            header={t('platform-information')}
            data={t('platform-information-desc')}
          />
          <div className="grid grid-cols-4 gap-2">
            <DataInfo
              header={t('address')}
        ...
        <div>
          <DataInfo
            header={t('os-information')}
            data={t('os-information-desc')}
          />
          <div className="grid grid-cols-4 gap-2">
            <DataInfo
              header={t('id')}
              data={node?.node_info?.os_version?._id}
            />
            <DataInfo
              header={t('arch')}
              data={node?.node_info?.os_version?.arch}
            />
            <DataInfo
              header={t('codename')}
            ...
            <DataInfo
              header={t('name')}
              data={node?.node_info?.os_version?.name}
            />
            <DataInfo
              header={t('patch')}
