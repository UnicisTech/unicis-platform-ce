  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-3 py-2.5 border-b border-slate-200 dark:border-slate-700">
        <span className="text-[11px] font-medium text-slate-900 dark:text-slate-100">Sections</span>
        <span className="text-xs text-slate-500 dark:text-slate-400">Click to filter</span>
      </div>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isActive && !isCritical && !isWarning && 'hover:bg-slate-50 dark:hover:bg-slate-700/50'
              )}
              ...
              <div className="flex items-center justify-between gap-1 mb-1.5">
                <span
                  className={cn(
                    ...
                    isActive ? 'text-ub-blue-text' : 'text-slate-700 dark:text-slate-200'
                  )}
                >
                  {sec.name}
                </span>
