...
export default function ControlMappingDrawer({
  ...
  return (
    <Drawer open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DrawerContent
        className="right-0 left-auto top-0 bottom-0 mt-0 h-full w-full max-w-lg rounded-none border-l bg-white dark:bg-slate-800 [&>div:first-child]:hidden sm:rounded-l-lg"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto divide-y">
          <section className="p-4">
            ...
            {!mappingEntry || otherFrameworks.length === 0 ? (
              <div className="text-center py-8 text-slate-500/70">
                <svg
                ...
                {otherFrameworks.map((fw) => {
                  ...
                  if (!mapped || mapped.length === 0) {
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2 px-3 py-2 bg-slate-100/60 dark:bg-slate-700/60">
                  ...
                  return (
                    <div key={fw} className="rounded-lg border overflow-hidden">
                      <div className="flex items-center gap-2 px-3 py-2 bg-slate-100/80">
                      ...
                      <div className="divide-y">
                        {mapped.map((mappedId) => {
                          ...
                          return (
                            <div
                              key={mappedId}
                              className="px-3 py-2.5 hover:bg-slate-100/40 dark:hover:bg-slate-700/40 transition-colors"
                            >
                              <div className="flex items-start gap-2">
                                ...
                                <div className="min-w-0 flex-1">
                                  {sectionLabel && (
                                    <p className="text-[10px] uppercase tracking-wider text-slate-500 dark:text-slate-400 font-semibold leading-none mb-0.5">
                                      {sectionLabel}
                                    </p>
                                  )}
                                  {controlName && (
            ...
            {linkedTasks.length === 0 ? (
              ...
              <div className="space-y-2">
                {linkedTasks.map((task) => (
                  <div
                    key={task.id}
                    className="flex items-center gap-3 p-3 rounded-lg bg-slate-100/60 dark:bg-slate-700/60 border"
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      {task.status && (
                        <span className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 block capitalize">
                  ...
                  {unlinkedTasks.map((task: any) => (
                    <button
                      ...
                      className={cn(
                        ...
                        'hover:border-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50'
                      )}
                    >
        ...
        <div className="px-4 py-3 border-t bg-slate-100/60 dark:bg-slate-700/60">
